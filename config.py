...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6989234920:AAHCM8u6G2u9wO5oo5G_Wkoci3gUGqbC8iQ")
...
# ID Channel Database
CHANNEL_DB = int(os.environ.get("CHANNEL_DB", "-1001711787723"))

# Database
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://maxjjebe:PnoUpO_mIrcgxXaurhSWXGhbuzt2ndvN@kiouni.db.elephantsql.com/maxjjebe")
...
FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1002033198199"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1001908767450"))
FORCE_SUB_3 = int(os.environ.get("FORCE_SUB_3", "-1001969438306"))
FORCE_SUB_4 = int(os.environ.get("FORCE_SUB_4", "-1001710007485"))
